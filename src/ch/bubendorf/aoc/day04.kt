...
fun main(args : Array<String>) {
    /*val input = "dies ist gut\n" +
            "dies ist ebenfalls gut\n" +
            "aber der macht aber probleme\n" +
            "und auch der ist der falsche\n"*/
    ...
    var input = "oaoe rxeq vssdqtu xrk cjv yaoqp loo\n" +
            ...
            input += "lvol xic hqqdeo gmsug yqe wue vhmrq buj juv wxexdot\n" +
            ...
            input += "yoepae uabuxlz jzqy yoepae sxena jzqy\n" +
            ...
            input += "aehljyc wrj lfhife xbss ztszba vlg eljycah ihffle coypll\n" +
            ...
            input += "ugxgzqt pdn hiynufo lpfabmi rmwj uhsqoo pmlzad ferdup guzqtxg voxd\n" +
            ...
            input += "uxjfm rmleg ochuj ruiq aobxbb tpuusot uhwjojw tutopus\n" +
            ...
            input += "iijm xgwq zzpskl qtjezqt yqjwy dhbq\n" +
    ...
    /*val anagram =  sortString("MachMalWasDraus")
    println("Test für Teil 2: $anagram")*/

    val validPhrases2 = input.split("\n")
...
//    println(input)
    return input.toCharArray().sortedArray().joinToString("")
}
